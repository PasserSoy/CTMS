layui.use(['layer','form','table'], function(){
  ...
  table.render({
    ...
    ,cols: [[ //表头
      ...
      ,{field: 'znum', title: '组号',align:'center'}
      ,{field: 'zname', title: '组名称',align:'center'}
      ,{field: 'zdes', title: '组描述',align:'center'}
      ,{field: 'location', title: '安装位置',align:'center'}
	...
	table.on('tool(mytable)', function(obj){
	  ...
	  if(layEvent === 'del'){ //删除
	    layer.confirm('确定要删除此组吗？',{ title:'提示',shadeClose:true,btnAlign: 'c',btn:['取消', '确定']},function(index){
	      // 取消
	      layer.close(index);
	    },function(index){
