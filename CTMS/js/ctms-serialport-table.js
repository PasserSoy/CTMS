layui.use(['layer','form','table'], function(){
  ...
  table.render({
    ...
    ,cols: [[ //表头
      ...
      ,{field: 'snum', title: '串口号',align:'center'}
      ,{field: 'bite', title: '波特率',align:'center'}
      ,{field: 'databit', title: '数据位',align:'center'}
      ,{field: 'stopbit', title: '停止位',align:'center'}
      ,{field: 'parity', title: '奇偶校验',align:'center'}
	...
	table.on('tool(mytable)', function(obj){
	  ...
	  if(layEvent === 'del'){ //删除
	    layer.confirm('确定要删除此串口吗？',{ title:'提示',shadeClose:true,btnAlign: 'c',btn:['取消', '确定']},function(index){
	      // 取消
	      layer.close(index);
	    },function(index){
